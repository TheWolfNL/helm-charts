...
*/}}
{{- define "thewolfnl.common.addon.vpn.scriptsVolumeSpec" -}}
{{- if or .Values.addons.vpn.scripts.up .Values.addons.vpn.scripts.down -}}
configMap:
  name: {{ include "thewolfnl.common.lib.chart.names.fullname" . }}-addon-vpn
  items:
...
*/}}
{{- define "thewolfnl.common.addon.vpn.configVolumeSpec" -}}
...
secret:
  ...
  {{- else }}
  secretName: {{ include "thewolfnl.common.lib.chart.names.fullname" . }}-addon-vpn-config
  {{- end }}
  items:
    - key: vpnConfigfile
      path: vpnConfigfile
