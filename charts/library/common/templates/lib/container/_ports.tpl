...
*/}}
{{- define "thewolfnl.common.lib.container.ports" -}}
  {{- $ports := list -}}
  {{- range $servicename, $service := .Values.service -}}
    ...
    {{- end -}}
    {{- if $serviceEnabled -}}
      {{- $enabledPorts := include "thewolfnl.common.lib.service.enabledPorts" (dict "serviceName" $servicename "values" $service) | fromYaml }}
