...
*/ -}}
{{- define "thewolfnl.common.lib.controller.pod" -}}
...
initContainers:
    ...
    {{- range $index, $key := (keys .Values.initContainers | uniq | sortAlpha) }}
      ...
      {{- if $container.env -}}
        ...
        {{- $newEnv := fromYaml (include "thewolfnl.common.lib.container.envVars" $) -}}
  ...
  {{- end }}
containers:
  {{- include "thewolfnl.common.lib.controller.mainContainer" . | nindent 2 }}
  ...
  {{- end }}
  {{- with (include "thewolfnl.common.lib.controller.volumes" . | trim) }}
volumes:
    {{- nindent 2 . }}
  {{- end }}
