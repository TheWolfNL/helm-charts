...
*/}}
{{- define "thewolfnl.common.class.ingress" -}}
  ...
  {{- end -}}
  {{- $defaultServicePort := get $primaryService.ports (include "thewolfnl.common.lib.service.primaryPort" (dict "values" $primaryService)) -}}
---
