...
Since a lot of the thewolfnl charts follow a similar pattern, this library was built to reduce maintenance cost between the charts that use it and try achieve a goal of being DRY.
...
- name: common
  version: 1.3.1
  repository: https://thewolfnl.github.io/helm-charts/
```
...
**Important**: When deploying an application Helm chart you can add more values from our common library chart [here](https://github.com/thewolfnl/helm-charts/tree/main/charts/library/common)

| Key | Type | Default | Description |
|-----|------|---------|-------------|
| addons | object | See below | The common chart supports several add-ons. These can be configured under this key. |
| addons.codeserver | object | See values.yaml | The common library supports adding a code-server add-on to access files. It can be configured under this key. For more info, check out [our docs](https://thewolfnl.github.io/helm-charts/docs/common-library/common-library-add-ons/##code-server) |
...
| persistence | object | See below | Configure persistence for the chart here. Additional items can be added by adding a dictionary key similar to the 'config' key. [[ref]](https://thewolfnl.github.io/helm-charts/docs/common-library/common-library-storage) |
...
| serviceMonitor.main.serviceName | string | `"{{ include \"thewolfnl.common.lib.chart.names.fullname\" $ }}"` | Configures the target Service for the serviceMonitor. Helm templates can be used. |
...
- See the [Docs](http://thewolfnl.github.io/helm-charts/docs/)
- Open an [issue](https://github.com/thewolfnl/helm-charts/issues/new/choose)
